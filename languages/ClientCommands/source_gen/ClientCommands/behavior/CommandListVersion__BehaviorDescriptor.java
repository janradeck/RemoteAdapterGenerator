...
public final class CommandListVersion__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x803175666604ec4L, 0x9045cc3f1cabfba1L, 0x2615a4c93fb84420L, "ClientCommands.structure.CommandListVersion");
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    // This handles the request from a StringValueReference within a ClientCommand looking for a StringValue
    if (SConceptOperations.isExactly(SNodeOperations.asSConcept(kind), CONCEPTS.StringValue$SL) && ScopeUtils.comeFrom(LINKS.versionCommands$zQfQ, __thisNode__, child)) {
      ListScope myStringValues = ListScope.forNamedElements(SLinkOperations.getChildren(__thisNode__, LINKS.versionConstants$GQ7p));
  ...
  /*package*/ CommandListVersion__BehaviorDescriptor() {
  }
